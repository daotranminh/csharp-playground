...
namespace RequestValidation.Models
{
    public class LimitCheckerAttribute : ValidationAttribute
    {
        ...
        {
            return string.Format(ErrorMessageString, name, Percentage, BaseProperty);
        }
        ...
        protected override ValidationResult IsValid(object value, ValidationContext validationContext)
        {
            ...
            if (propertyInfo != null)
            {
                ...
                if (amount < maxLimit) return ValidationResult.Success;
            }
